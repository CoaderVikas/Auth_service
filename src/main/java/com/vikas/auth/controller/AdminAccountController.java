...
public class AdminAccountController {
    ...
    @Operation(summary = "Lock User Account",
               description = "Locks a user account and prevents login access")
    @ApiResponses({
    ...
    @Operation(summary = "Update User Role",
               description = "Changes the role of a user (USER or ADMIN)")
    @ApiResponses({
	...
	@GetMapping("/users")
	public ResponseEntity<Page<AdminUserResponse>> getAllUsers(@RequestParam(name = "page",defaultValue = "0") int page,
